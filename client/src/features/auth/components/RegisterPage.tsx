    ...
    <main className="page-wrap flex min-h-[70vh] items-center justify-center px-4 py-12">
      <Card className="w-full max-w-md" style={{ background: 'var(--surface-strong)', border: '1px solid var(--line)' }}>
        <CardHeader className="pb-4">
          ...
          <CardTitle className="display-title text-3xl" style={{ color: 'var(--text-dark)' }}>Create an account</CardTitle>
          <CardDescription style={{ color: 'var(--text-soft)' }}>Start renting beautiful pieces today</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
            <div className="space-y-1.5">
              <Label htmlFor="name">Full name</Label>
              <Input id="name" type="text" autoComplete="name" placeholder="Arjun Sharma" aria-invalid={!!errors.name} {...register('name')} />
            ...
            <div className="space-y-1.5">
              ...
              <Input id="confirmPassword" type="password" autoComplete="new-password" placeholder="Repeat your password" aria-invalid={!!errors.confirmPassword} {...register('confirmPassword')} />
          ...
          <p className="mt-6 text-center text-sm" style={{ color: 'var(--text-soft)' }}>
            ...
            <Link to="/auth/login" className="font-semibold" style={{ color: 'var(--brand)' }}>Sign in</Link>
          </p>
        </CardContent>
      </Card>
    </main>
